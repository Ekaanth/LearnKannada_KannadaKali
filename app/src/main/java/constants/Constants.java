...
public class Constants {
    ...
    public static final String ENG_ARRAY = "Eng_array";
    public static final String ARRAY = "array";
    public static final String KAN_ARRAY = "Kan_array";
    public static final String KANNADA_KALI = "Kannada Kali";
    ...
    public static final String THUMB_RULE = "Thumb Rule";
