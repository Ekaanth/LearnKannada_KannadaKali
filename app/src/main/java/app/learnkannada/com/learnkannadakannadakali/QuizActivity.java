...
public class QuizActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
            ...
            public void onClick(View view) {
                                    ...
                                    PackageManager.PERMISSION_GRANTED)
                    {
                        if (ActivityCompat.shouldShowRequestPermissionRationale(QuizActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            ...
                            ActivityCompat.requestPermissions(QuizActivity.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_STORAGE_PERMISSION_GRANTED);

                        if (ActivityCompat.shouldShowRequestPermissionRationale(QuizActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)) {

                        } else
                            ActivityCompat.requestPermissions(QuizActivity.this, new String[]{android.Manifest.permission.READ_EXTERNAL_STORAGE}, READ_STORAGE_PERMISSION_GRANTED);
                    } else
    ...
    private void initViews() {
        optionOneCard = (CardView) findViewById(R.id.qa_optionOneCardID);
        optionTwoCard = (CardView) findViewById(R.id.qa_optionTwoCardID);
        optionThreeCard = (CardView) findViewById(R.id.qa_optionThreeCardID);
        optionFourCard = (CardView) findViewById(R.id.qa_optionFourCardID);
        optionOneTextView = (TextView) findViewById(R.id.qa_optionOneID);
        optionTwoTextView = (TextView) findViewById(R.id.qa_optionTwoID);
        optionThreeTextView = (TextView) findViewById(R.id.qa_optionThreeID);
        optionFourTextView = (TextView) findViewById(R.id.qa_optionFourID);
        questionTextView = (TextView) findViewById(R.id.qa_questionID);
        nextButton = (Button) findViewById(R.id.qa_nextID);
        countTextView = (TextView) findViewById(R.id.qa_countID);
        ...
        if (id == R.id.helpID) {
            if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.READ_EXTERNAL_STORAGE) !=
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_STORAGE_PERMISSION_GRANTED);

                if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.READ_EXTERNAL_STORAGE)) {

                } else
                    ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.READ_EXTERNAL_STORAGE}, READ_STORAGE_PERMISSION_GRANTED);
            } else
                shareScreenShot();
        }
