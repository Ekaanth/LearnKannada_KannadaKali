...
public class ChooseCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayOfArrays = new String[][]{getResources().getStringArray(R.array.back_to_school_content),
                getResources().getStringArray(R.array.vegetables_content),
                getResources().getStringArray(R.array.fruits_content),
                getResources().getStringArray(R.array.beginner_content),
                getResources().getStringArray(R.array.days_content),
                getResources().getStringArray(R.array.time_content),
                getResources().getStringArray(R.array.greetings_content),
                getResources().getStringArray(R.array.directions_content),
                getResources().getStringArray(R.array.relationships_content),
                getResources().getStringArray(R.array.colors_content),
                getResources().getStringArray(R.array.body_parts_content),
