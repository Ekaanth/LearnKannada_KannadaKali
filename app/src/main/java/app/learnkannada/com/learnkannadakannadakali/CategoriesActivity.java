            ...
            builder.setView(view)
                    ...
                    .setPositiveButton("Suggest", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            body.append("I think it would be really helpful if you can add below " + content + "\n\n");
                            ...
                            intent.putExtra(Intent.EXTRA_SUBJECT, "Kannada Kali - Suggest " + content);
                    ...
                    .setIcon(R.drawable.conversations_black)
